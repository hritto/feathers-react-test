...
const Menu = function (opts, resizer_obj, ins, al, co, sc, ok_index, ko_index, callInitPrev, callEndAll, callReload, callInitNext) {
  var config = opts;
  ...
  //Calbacks APP
  var initPrevActivity = callInitPrev;
  var endAllActivities = callEndAll;
  var reloadActivity = callReload;
  var initNextActivity = callInitNext;
