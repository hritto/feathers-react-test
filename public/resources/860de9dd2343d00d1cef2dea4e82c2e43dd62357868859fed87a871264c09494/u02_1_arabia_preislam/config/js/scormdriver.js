// Archivo scormdriver.js v1.0 - Actualizado el 28/02/2015
...
******************************************************************************************/
function LMSSetValue(name, value){
  //if (window.console) console.log("LMSSetValue");
  //if (window.console) console.log("LMSSetValue: Name = "+name+", Value = "+value+"");
   var api = getAPIHandle();
   if (api == null) {
     // alert("Unable to locate the LMS's API Implementation.\nLMSSetValue was not successful.");
   } else {
      var result = api.LMSSetValue(name, value);
	  if (window.console) console.log("LMSSetValue: Name = "+name+", Value = "+value+", Result = "+result);
	  LMSCommit();
      var err = ErrorHandler();
   }
   return;
...
function getAPI(){	
  ...
  while (tries < triesMax && theAPI == null){
    ...
    try {
			...
			if (window.console){console.log("Cazando error de crossdomain");}
		}
			tries++;
