...
function drawDrag() {
	...
	$.each(items, function(i, v) {		
		...
		var nom_clean = nom_text||nom_imagen||nom_img||nom_locucion||nom_video||nom_file; // si es texto devuelve text() y si es imagen devuelve trim
			...
			tAnchor += ' style="top:'+posV+'; left:'+posH+';  width:'+width+'; height:'+height+'; opacity:'+opaBG+'; background-color:'+BgColor+';"';
...
function actDragnDropFinalizada(Estado, ratio){
	...
	if(Estado == 'Correcto'){
		gestionarSCO(pantallas, currentIndex, 1);
